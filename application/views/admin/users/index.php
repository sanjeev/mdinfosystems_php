...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
                        <a  href="<?php echo base_url(); ?>index.php/admin/users/add" ><button class="btn btn-block btn-primary btn-lg">Add Users</button></a>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url(); ?>index.php/admin/users/edit/<?php echo $user->id; ?>">Edit</a></li>
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/users/delete/<?php echo $user->id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
