...
<html>
  <head>
    ...
    <title>localhost/adminpanel | Edit user</title>
      ...
      <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li  class="active" ><a href="<?php echo base_url(); ?>index.php/admin/users">users</a></li>
...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
             ...
             <form method="post" action="<?php echo base_url(); ?>index.php/admin/users/edit/<?php echo $user->id; ?>" enctype="multipart/form-data">
				  <div class="row">
				  <div class="col-md-6">
				  </div>
					<div class="col-md-6">
						<div class="btn-group pull-right">
							...
							<a href="<?php echo base_url(); ?>index.php/admin/users" class="btn btn-default">Close</a>
					</div>
				  </div>
				</div><!-- /.row -->
