...
<html>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>index.php/admin/admins"><i class="fa fa-dashboard"></i> Home</a></li>
            <li  class="active" >Admins & Users</li>
 ...
 <?php if($this->session->flashdata('admin_saved')) : ?> 
 	<?php echo '<p class="alert alert-success">' .$this->session->flashdata('admin_saved') . '</p>'; ?>
 <?php endif; ?>

 <?php if($this->session->flashdata('admin_deleted')) : ?> 
 	<?php echo '<p class="alert alert-success">' .$this->session->flashdata('admin_deleted') . '</p>'; ?>
 <?php endif; ?>
...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
            <a href="<?php echo base_url(); ?>index.php/admin/admins/add"><button class="btn btn-block btn-primary btn-lg">Add Admins</button></a>
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url(); ?>index.php/admin/admins/edit/<?php echo $admin->id; ?>">Edit</a></li>
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/admins/delete/<?php echo $admin->id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
