...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
             ...
             <form method="post" action="<?php echo base_url(); ?>index.php/admin/admins/edit/<?php echo $admin->id; ?>" enctype="multipart/form-data">
				  <div class="row">
				  <div class="col-md-6">
				  </div>
					<div class="col-md-6">
		...
		<?php echo form_open_multipart('index.php/admin/admins/edit');?> 
    ...
    <!-- FastClick -->
    <script src="<?php echo base_url(); ?>assets/css/plugins/fastclick/fastclick.min.js"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo base_url(); ?>assets/css/dist/js/app.min.js"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="<?php echo base_url(); ?>assets/css/dist/js/demo.js"></script>
  </body>
</html>
