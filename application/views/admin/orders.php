...
<html>
 ...
 <li><a href="<?php echo base_url(); ?>index.php/admin/subcategories_admin"><i class="fa fa-circle-o"></i> Sub-Categories</a></li>
 	...
 	<?php echo '<p class="alert alert-success">' .$this->session->flashdata('order_deleted') . '</p>'; ?>
 <?php endif; ?>
          <h1>
            Orders
            <small>Details</small>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $orders_details[$order->id]->quantity;?></td>
                        <td><?php echo $orders_details[$order->id]->price;?></td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/orders/delete/<?php echo $order->id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
