 ...
 <li><a href="<?php echo base_url(); ?>index.php/admin/subcategories_admin"><i class="fa fa-circle-o"></i> Sub-Categories</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
             <?php if($this->session->flashdata('Subscription_deleted')) : ?> 
 	<?php echo '<p class="alert alert-success">' .$this->session->flashdata('Subscription_deleted') . '</p>'; ?>
 <?php endif; ?>
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Subscriptions Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                         <td><?php echo $subscription->id_subscriptions; ?></td>
                        <td><?php echo $subscription->mails;?></td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/subscriptions/delete/<?php echo $subscription->id_subscriptions; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
