 ...
 <li><a href="<?php echo base_url(); ?>index.php/admin/subcategories_admin"><i class="fa fa-circle-o"></i> Sub-Categories</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
             <?php if($this->session->flashdata('search_deleted')) : ?> 
 	<?php echo '<p class="alert alert-success">' .$this->session->flashdata('search_deleted') . '</p>'; ?>
 <?php endif; ?>
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $search->search_content;?></td>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/searches/delete/<?php echo $search->search_id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
