...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
        ...
        <section class="content">
            <a href="<?php echo base_url(); ?>index.php/admin/categories_admin/add"><button class="btn btn-block btn-primary btn-lg">Add Category</button></a>
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url(); ?>index.php/admin/categories_admin/edit/<?php echo $category->id; ?>">Edit</a></li>
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/categories_admin/delete/<?php echo $category->id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
