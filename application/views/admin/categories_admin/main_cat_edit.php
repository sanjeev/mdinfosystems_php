...
<div class="box box-primary">
        ...
        <section class="content">
           ...
           <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/admin/categories_admin/main_cat_edit/<?php echo $category->id; ?>">
				  <div class="row">
				  <div class="col-md-6">
				  </div>
					<div class="col-md-6">
