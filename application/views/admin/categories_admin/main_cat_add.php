      ...
      <!-- Content Header (Page header) -->
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li  class="active" ><a href="<?php echo base_url(); ?>index.php/admin/categories_admin">Main Categories</a></li>
...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
           <form method="post" action="<?php echo base_url(); ?>index.php/admin/categories_admin/main_cat_add" enctype="multipart/form-data">
				  <div class="row">
				  <div class="col-md-6">
				  </div>
					<div class="col-md-6">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="name" placeholder="Enter Main Category Name" />
							</div>				
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022-2023 <a href="">Adminpanel </a>.</strong> All rights reserved.
      </footer>
