					 ...
					 <label>Main Category</label>
						<select name="main_categories" class="form-control" required = "required">
							...
							<?php foreach($main_categories as $category){ ?>
							 <option value="<?php echo $category['id'];?>" <?Php if($product->main_categories==$category['id']){ echo ' selected="selected"';} ?> ><?php echo $category['name'];?></option>
						 <?php }?>
						</select>
						</div>
					<!--<div class="col-lg-12">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="product_name" id="title" value="<?php echo $product->product_name; ?>" placeholder="Enter Product Name" />
                                         ...
                                         <div class="col-lg-12">   <div id="selectImage">
		...
		<?php echo "<input type='file' accept='image/*'  name='userfile' value='$product->product_image' size='20' id='image'/>"; ?>
						...
						<div class="col-md-6">
							...
							<?php foreach($categories as $value){  ?>
							  <option value="<?php echo $value->id;?>" <?php if($value->id==$product->category_id) { echo 'selected="selected"'; } ?>><?php echo $value->name;?></option>
								<?php } ?>
							</select>
						</div>
					<div class="col-md-6">
							...
							<select name="subcategory" class="form-control" id="sub_category_id" required = "required">
							  ...
							  <option value="<?php echo $value->id;?>" <?php if($value->id==$product->subcategory_id) { echo 'selected="selected"'; } ?>><?php echo $value->name;?></option>
								<?php } ?>
							</select>
						</div>
						...
						<select name="model" class="form-control" id="modelid" required = "required">
							<option value="">Select Model</option>
							 <?php foreach($model as $value){  ?>
							  <option value="<?php echo $value['id'];?>" <?php if($value['id']==$product->model_id) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
								<?php } ?>
						</select>
						</div>
					<div class="col-md-6">
						...
						<select name="brand" class="form-control" id="brandid" required = "required">
							<option value="">Select Brand</option>
							 <?php foreach($brand as $value){  ?>
							  <option value="<?php echo $value['id'];?>" <?php if($value['id']==$product->brand_id) { echo 'selected="selected"'; } ?>><?php echo $value['name'];?></option>
								<?php } ?>
						</select>
						</div>              
