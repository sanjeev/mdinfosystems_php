...
<?php echo validation_errors('<p class="alert alert-dismissable alert-danger">'); ?>
 ...
 <?php endif; ?>
            <form method="post" action="<?php echo base_url(); ?>index.php/admin/products_admin/multipleadd" enctype="multipart/form-data">
			  
				<div class="row">
				<div class="col-md-12">                          
                 <div id="selectImage">
					<label>Product Image</label><br>
					<?php echo form_open_multipart('index.php/admin/products_admin/multipleadd');?> 
					<?php echo "<input type='file'  name='files[]' multiple='multiple' size='20' id='file' required = 'required'/>"; ?>
				</div>
            </div>
             <br>
