            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Wishlists Table</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                     <?php foreach($wishes as $wish) : ?>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/wishlists/delete/<?php echo $wish->id; ?>">Delete</a></li>
                      </ul>
                    </div></td>
                      </tr>
                <?php endforeach; ?>
